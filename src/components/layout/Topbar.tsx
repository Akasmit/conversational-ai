...
export function Topbar() {
    ...
    return (
        <header className="sticky top-0 z-10 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-0 dark:bg-white/80 supports-[backdrop-filter]:dark:bg-white/60 dark:text-black">
